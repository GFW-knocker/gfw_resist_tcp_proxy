...
quic_verify_cert = False  # Kept as False since we only have a self-signed certificate (cert.pem, key.pem)
...
# Use environment variable for quic_auth_code to improve security; falls back to default if not set
quic_auth_code = os.getenv('QUIC_AUTH_CODE', 'jd!gn0s4')  # Internal QUIC auth between client and server
